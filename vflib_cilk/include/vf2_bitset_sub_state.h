...
#ifndef VF2_BS_SUB_STATE_H
#define VF2_BS_SUB_STATE_H
 ...
 * See vf2_sub_state.cc for more details.
 ---------------------------------------------------------*/
class VF2BitSubState: public State
{
...
private:
	...
	CBitSet* in_1, *in_2, *out_1, *out_2;
	CBitSet* min_1, *min_2, *mout_1, *mout_2;
...
public:
	VF2BitSubState(Graph* g1, Graph* g2, bool sortNodes = false);
	VF2BitSubState(const VF2BitSubState& state);
	VF2BitSubState(const VF2BitSubState& state, bool deep);
	~VF2BitSubState();
	Graph* GetGraph1()
	{
		return g1;
