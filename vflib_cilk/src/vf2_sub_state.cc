...
VF2SubState::VF2SubState(const VF2SubState& state, bool deep)
{
    if (!deep)
    {
        return;
...
void VF2SubState::propogate(const State& state1)
{
    VF2SubState& state = (VF2SubState&) state1;
...
State* VF2SubState::DeepClone()
{
    return new VF2SubState(*this, true);
}
